...
- Backend: a dedicated Supabase project in the personal org (ref `iqpwyiiltchrrnxdfaxm`) — separate from the examloop project. Password: `nehal84` (stored as a sha256 hash in the DB).
